                ...
                <div id={style.displayHeadingBox}> 
                     ...
                     <div id={style.tableBox}>
                         <table>
                            <thead >
                               <tr>
                                  <th id={style.center}>Nom de la question</th>
                                  <th id={style.center}>Option un</th>
                                  <th id={style.center}>Option deux</th>
                                  <th id={style.center}>Option trois</th>
                                  <th id={style.center}>Option quatre</th>
                                  <th id={style.center}>Question Réponse</th>
                   ...
                   <div id={style.addBox} style={display}>   
                        ...
                        <label>Saisir la question </label>
