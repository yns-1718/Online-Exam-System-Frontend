...
import ProfSignup from "./Components/ProfComponent/ProfSignup/ProfSignup";
import ProfDashboardd from "./Components/ProfComponent/ProfDashboardd/ProfDashboard";


import {Route , BrowserRouter , Switch} from "react-router-dom";
import StudentSignup from "./Components/StudentComponent/StudentSignup/StudentSignup";
import ProfLogin from "./Components/ProfComponent/ProfLogin/ProfLogin";
        ...
        <>
          <BrowserRouter>
              <Switch>
                  ...
                  <Route exact path="/ProfSignup"  component={ProfSignup}></Route>
                  <Route exact path="/ProfLogin"  component={ProfLogin}></Route>
                  ...
                  <Route exact path="/ProfDashboardd" component={ProfDashboardd}></Route>
              </Switch>
          </BrowserRouter>
        </>
      );
